...
if __name__ == "__main__":
    # 读取 Excel 文件并处理数据
    file_path = r"C:\pythonCode\essayPY\Topsis\topsistext\TopsisDataInput\UR2\2015年川渝地区人口方向对UR的影响因子.xlsx"
    ...
    df_Vi.to_excel(r"C:\pythonCode\essayPY\Topsis\topsistext\TopsisOutPut\out2015年川渝地区人口方面对UR的综合评分指数.xlsx", index=False)
